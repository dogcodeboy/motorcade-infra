# 🟨 26 — DNS_02
## DNS record lifecycle via intent (safe changes + TTL policy)
...
1. Define authoritative DNS ownership and the set of managed zones/records.
1. Define safe record-change workflow (intent-driven) with rollback and TTL policy.
1. Define certificate validation hooks and restrictions.
