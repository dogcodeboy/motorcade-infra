# 🟨 21 — Email_02
## Addressing + baseline mailboxes (legal/compliance/billing/etc.)
...
1. Define mail domains, mailbox naming, and system account ownership.
1. Define employee access path: portal UI + approved clients only (no direct server UI).
1. Define logging/retention for compliance and evidence preservation.
...
- Supporting: [`docs/runbook-attachments/STEP_ADMIN_AI_EMAIL_GOVERNANCE.md`](docs/runbook-attachments/STEP_ADMIN_AI_EMAIL_GOVERNANCE.md)
