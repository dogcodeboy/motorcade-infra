# 🟨 11 — SSO_03
## Multi-organization logins for client portal (site-scoped access)
...
1. Define auth boundary: identity provider(s), MFA, session duration, and device policy.
1. Map roles to permissions (RBAC) and ensure Admin-AI enforces authorization, not the IdP.
