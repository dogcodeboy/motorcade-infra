...
## Employee roles + permissions model (dispatch/supervisor/payroll)
...
1. Define the user types, limits, and scope boundaries (org/site).
1. Define approval workflows and what actions are allowed at each role.
1. Define notifications/audit exposure rules (safe summaries).
