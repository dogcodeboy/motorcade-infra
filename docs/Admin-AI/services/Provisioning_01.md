# 🟨 44 — Provisioning_01
## Provider adapter boundary (AWS roles; no long-lived creds)
...
1. Define provider adapter boundary and required IAM roles.
1. Define worker admission protocol inputs/outputs and config delivery constraints.
1. Define autoscaling guardrails, caps, and cooldowns consistent with intent lock.
