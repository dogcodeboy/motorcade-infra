# 🟨 15 — LDAP_02
## Account state model (active / reduced suspension / full suspension)
...
1. Define the directory objects (users, groups, service accounts, devices) and the naming conventions.
1. Define account lifecycle states and enforce suspension rules (reduced vs full suspension).
1. Define termination and evidence-preservation requirements (no deletion without policy).
...
- Supporting: [`docs/runbook-attachments/STEP_ADMIN_AI_LDAP_GOVERNANCE.md`](docs/runbook-attachments/STEP_ADMIN_AI_LDAP_GOVERNANCE.md)
