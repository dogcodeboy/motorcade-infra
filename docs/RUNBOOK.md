...
5. `PLAT_02_postgres_phase1.yml` (containerized DB)
6. `PLAT_03_lead_intake_api.yml`
7. `PLAT_04_people_api.yml`
8. `PLAT_05_reverse_proxy_routes.yml`
9. `PLAT_06_backups_postgres_to_s3.yml`

### Identity (SSO / directory)
10. `ID_01_keycloak_bootstrap.yml`
11. `ID_02_freeipa_directory.yml`
12. `ID_03_service_accounts_and_rbac.yml`

### Mail/Calendar (groupware)
13. `MAIL_01_mailcow_deploy.yml`
14. `MAIL_02_imap_migrate.yml`
15. `MAIL_03_branding.yml`
